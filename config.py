...
USER_LOGIN_TOKEN_EXPIRE_MINUTES = config("USER_LOGIN_TOKEN_EXPIRE_MINUTES", cast=int, default=15)
USER_SESSION_EXPIRE_MINUTES = config("USER_SESSION_EXPIRE_MINUTES", cast=int, default=1440)
USER_SESSION_COOKIE_NAME = config("USER_SESSION_COOKIE_NAME", default="np_user_session")
